...
describe("Table Storage Tests", function ()
{
    ...
    beforeEach(async function()
    {
       [acc1,acc2,acc3,acc4, acc5,acc6,acc7,acc8,acc9,acc10,
        ...
        const TableStorage2 = await ethers.getContractFactory("TableStorage", owner);
        tableStorage2 = await TableStorage2.deploy();
        await tableStorage2.deployed();
        tableStorageAddres2 = tableStorage2.address;
        tableStorage2.SetKey();
   ...
   {
    let tx = await tableController.BuyTable(1,  acc1.address);
    await tx.wait();
    let tx1 = await tableController.BuyTable(2,  acc1.address);
    await tx1.wait();
    let tx2 = await tableController.BuyTable(3,  acc1.address);
    await tx2.wait();
    let tx3 = await tableController.BuyTable(4, acc1.address);
    await tx3.wait();
    
    let txSome = await tableController.BuyTable(4,  acc2.address);
    await txSome.wait();

    let tx4 = await tableController.BuyTable(5,  acc1.address);
    await tx4.wait();
    let tx5 = await tableController.BuyTable(6,  acc1.address);
    await tx5.wait();
    let tx6 = await tableController.BuyTable(7, acc1.address);
    await tx6.wait();
    let tx7 = await tableController.BuyTable(8, acc1.address);
    await tx7.wait();
    let tx8 = await tableController.BuyTable(9,  acc1.address);
    await tx8.wait();
    let tx9 = await tableController.BuyTable(10, acc1.address);
    await tx9.wait();
    let tx10 = await tableController.BuyTable(11,  acc1.address);
    await tx10.wait();
    let tx11 = await tableController.BuyTable(12,  acc1.address);
    await tx11.wait();
    let tx12 = await tableController.BuyTable(13,  acc1.address);
    await tx12.wait();
    let tx13 = await tableController.BuyTable(14,  acc1.address);
    await tx13.wait();
    let tx14 = await tableController.BuyTable(15,  acc1.address);
    await tx14.wait();
    let tx15 = await tableController.BuyTable(16,  acc1.address);
    await tx15.wait();
   ...
   it("Deactivate unnecessary Table", async function()
   {
        ...
        let reg5 = await userController.Register( acc5.address, 1);
        await reg5.wait();
        let tx5 = await tableController.BuyTable(1,  acc5.address );
        await tx5.wait();
        let reg6 = await userController.Register( acc6.address, 1);
        await reg6.wait();
        let tx6 = await tableController.BuyTable(1,  acc6.address );
        await tx6.wait();
        let reg7 = await userController.Register( acc7.address, 1);
        await reg7.wait();
        let tx7 = await tableController.BuyTable(1,  acc7.address );
        await tx7.wait();
        let reg8 = await userController.Register( acc8.address, 1);
        await reg8.wait();
        let tx8 = await tableController.BuyTable(1,  acc8.address );
        await tx8.wait();
        let reg9 = await userController.Register( acc9.address, 1);
        await reg9.wait();
        let tx9 = await tableController.BuyTable(1,  acc9.address );
        await tx9.wait();
        let reg10 = await userController.Register( acc10.address, 1);
        await reg10.wait();
        let tx10 = await tableController.BuyTable(1,  acc10.address );
        await tx10.wait();
        ...
        let reg11 = await userController.Register( acc11.address, 1);
        await reg11.wait();
        let tx11 = await tableController.BuyTable(1,  acc11.address );
        await tx11.wait();
   ...
   {
    let tx = await tableController.AddRewardSum(1, 1, 100000000);
    await tx.wait();

    let tx1 = await tableController.AddReferalPayout(1, 200000000);
    await tx1.wait();
    ...
    let tx2 = await tableController.AddRewardSum(1, 1, 100000000);
    await tx2.wait();

    let tx3 = await tableController.AddReferalPayout(1, 200000000);
    await tx3.wait();
